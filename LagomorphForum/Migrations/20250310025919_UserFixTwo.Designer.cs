...
namespace LagomorphForum.Migrations
{
    ...
    [Migration("20250310025919_UserFixTwo")]
    partial class UserFixTwo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LagomorphForum.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("LagomorphForum.Models.Comment", b =>
                {
                    ...
                    b.HasOne("LagomorphForum.Data.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LagomorphForum.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
